...
public interface GoodsMapper {
    ...
    List<Goods> queryGoodsByCondition(@Param("cId") Integer categoryId, @Param("bId") Integer brandId, @Param("isHot") boolean isHot, @Param("isNew") boolean isNew, @Param("key") String keyword);
